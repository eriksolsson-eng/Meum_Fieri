...
<style>
    .sight-view {
        ...
        height: 1800px;
        background: #000;
        overflow: hidden; /* Hides overflowing elements without cropping */
        box-shadow: 0 20px 60px rgba(0, 0, 0, 0.9);
        /* Optional: Use clip-path for circular/elliptical sight view */
    ...
    .sight-overlay img {
        width: 1800px;  /* Scale sight_small.png to exactly 1800x1800px */
        height: 1800px;
        position: absolute;
        left: 50%;
        top: 50%;
...
<div class="sight-view">
    ...
    <div class="background-layer" style="transform: translate(calc(-50% + {backgroundMovement}px), {backgroundElevationShift}px);">
        <img src="assets/graphics/background.png" alt="Terrain Background" />
    </div>

    <!-- Sight Reticle (Always centered - NO elevation movement) -->
    <div class="sight-overlay" style="transform: translate(-50%, 0);">
        <img src="assets/graphics/sight_small.png" alt="Mortar Sight Reticle" />
    </div>
    ...
    <div class="stick-layer front-stick" style="transform: translate(calc(-50% + {frontStickMovement}px), {frontStickElevationShift}px);">
        <img src="assets/graphics/front_stick.png" alt="Front Aiming Stick" />
    </div>
    ...
    <div class="stick-layer back-stick" style="transform: translate(calc(-50% + {backStickMovement}px), {backStickElevationShift}px);">
        <img src="assets/graphics/back_stick.png" alt="Back Aiming Stick" />
    </div>
</div>
